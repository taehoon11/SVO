...
if("TRUE" STREQUAL "TRUE")
  set(minkindr_conversions_SOURCE_PREFIX /workspace/svo_ws/src/minkindr_ros/minkindr_conversions)
  set(minkindr_conversions_DEVEL_PREFIX /workspace/svo_ws/devel/.private/minkindr_conversions)
  ...
  set(minkindr_conversions_INSTALL_PREFIX /workspace/svo_ws/install)
...
if(NOT "/workspace/svo_ws/src/minkindr_ros/minkindr_conversions/include " STREQUAL " ")
  set(minkindr_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/svo_ws/src/minkindr_ros/minkindr_conversions/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'minkindr_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/svo_ws/src/minkindr_ros/minkindr_conversions/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/svo_ws/devel/.private/minkindr_conversions/lib;/workspace/svo_ws/devel/lib;/opt/ros/noetic/lib)
