...
if("TRUE" STREQUAL "TRUE")
  set(tf_SOURCE_PREFIX /workspace/svo_ws/src/geometry/tf)
  set(tf_DEVEL_PREFIX /workspace/svo_ws/devel/.private/tf)
  set(tf_INSTALL_PREFIX "")
  set(tf_PREFIX ${tf_DEVEL_PREFIX})
else()
  set(tf_SOURCE_PREFIX "")
  set(tf_DEVEL_PREFIX "")
  set(tf_INSTALL_PREFIX /workspace/svo_ws/install)
...
if(NOT "/workspace/svo_ws/devel/.private/tf/include;/workspace/svo_ws/src/geometry/tf/include " STREQUAL " ")
  set(tf_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/svo_ws/devel/.private/tf/include;/workspace/svo_ws/src/geometry/tf/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/svo_ws/src/geometry/tf/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/svo_ws/devel/.private/tf/lib;/workspace/svo_ws/devel/lib;/opt/ros/noetic/lib)
