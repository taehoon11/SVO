...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /workspace/svo_ws/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /workspace/svo_ws/devel/.private/eigen_conversions)
  ...
  set(eigen_conversions_INSTALL_PREFIX /workspace/svo_ws/install)
...
if(NOT "/workspace/svo_ws/src/geometry/eigen_conversions/include;/usr/include/eigen3;/usr/share/orocos_kdl/cmake/../../../include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/svo_ws/src/geometry/eigen_conversions/include;/usr/include/eigen3;/usr/share/orocos_kdl/cmake/../../../include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/svo_ws/src/geometry/eigen_conversions/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/svo_ws/devel/.private/eigen_conversions/lib;/workspace/svo_ws/devel/lib;/opt/ros/noetic/lib)
